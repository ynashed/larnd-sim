...
def main(param=None, n_noise=None):
    individual_f_list = os.listdir("nominal_vals_batch/")

    target_file_dir = f"noisy_sample{n_noise}_batch//"
    all_dist = {}
    ...
    with open(f"collect_adc_dtw_{param}_vs_noisy_target_sample{n_noise}.pkl", "wb") as file:
...
if __name__ == "__main__":
    ...
    main(param=args.param, n_noise=args.n_noise)