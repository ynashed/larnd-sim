...
# StaticParams = namedtuple('StaticParams', [
#         'tpc_borders'
#     ])

# VaryingParams = namedtuple('VaryingParams', [
#         'eField',
#         'Ab',
#         'kb',
#         'lifetime',
...
# Params = namedtuple("Params", StaticParams._fields + VaryingParams._fields)


# def jit_params(f, static_argnames=[]):
#     def _f(var_params, static_params, *args, **kwargs):
#         print("var_params:", var_params)
#         print("*args:", args)
#         print("**kwargs:", kwargs)
#         params = Params(*(var_params + static_params))
#         return f(params, *args, **kwargs)
#     if not isinstance(static_argnames, list):
#         static_argnames = [static_argnames]
#     static_argnames.append('static_params')
#     print(jit(_f, static_argnames=static_argnames))
